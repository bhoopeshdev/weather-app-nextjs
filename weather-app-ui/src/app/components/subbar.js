...
const SubBar = ({dayData}) => {
    ...
    return (
        <div className="h-60 flex flex-row overscroll-auto overflow-auto">
          <div className="col-span-1 p-8 mr-4 min-w-60 bg-secondary h-full rounded-3xl flex flex-col justify-between">
            <p className="text-sm font-bold ">Humidity</p>
            <p className='text-7xl font-bold '>{dayData.avghumidity}<span class="percentage-sub">%</span></p>
